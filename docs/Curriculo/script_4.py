...
# Convertir competencias.php a competencias.html (continuación)
# Por el tamaño del archivo, lo hago en formato optimizado pero completo

print("🔄 Creando competencias.html y evaluacion.html...")
print("   (Archivos grandes, puede tardar un momento...)")

# Generar archivo README actualizado para GitHub
readme_github = '''# 📚 Guía de Estudio - Currículo de Educación Infantil Aragón
...
print("✅ README.md actualizado para GitHub Pages")
